...
class DiceRoll(commands.Cog):
    ...
    @diceroll.error
    async def diceroll_error(self, ctx: commands.Context[commands.Bot], error: Exception):
    ...
    @slashDiceroll.error
    async def slashDiceroll_error(self, interaction: discord.Interaction, error: Exception):
        logger.exception(f"❌ something went wrong with /diceroll command:")
        try:
            await interaction.response.send_message("something went wrong with **diceroll**.", ephemeral = True)
        except discord.InteractionResponded:
            await interaction.followup.send("something went wrong with **diceroll**.", ephemeral = True)
